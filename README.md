...
- List there books bay adding the name and the auther.
- removing the books that the user finish it.
...
[Live Demo](https://boo-shehab.github.io/Bookstore/)
...
```sh
  git clone https://github.com/boo-shehab/BOOKSTORE.git
```
